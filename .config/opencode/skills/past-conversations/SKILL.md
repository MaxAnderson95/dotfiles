...
description: Search past conversations with the user from the local SQLite database. Use when the user references a previous discussion, asks "do you remember", or needs context from earlier sessions.
---
